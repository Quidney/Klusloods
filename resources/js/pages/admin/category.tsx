...
const CategoriePage = ({ categories }) => {
    const searchparm=Object.fromEntries(new URLSearchParams(window.location.search)).search;
    const [searchTerm, setSearchTerm] = useState(searchparm);
    ...
    return (
        <>
        <AddCategory isOpen={isOpen} onClose={()=>setIsOpen(false)} setCategory={setCategories}/>
                ...
                <div className="flex flex-col gap-8 lg:flex-row">
                    <main className="flex-1">
                        ...
                        <div className="mb-8 flex gap-4">
                            ...
                            <button onClick={()=>setIsOpen(true)} className="rounded-xl bg-orange-500 p-4 text-white shadow-lg shadow-orange-500/20 transition-transform hover:scale-105 hover:bg-orange-600 active:scale-95">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                                {category.map((item) =>(
                                    <CategorieComp key={item.id} item={item} setCategory={setCategories}/>
                                ) )}
                            </div>
                        </div>
                    </main>
